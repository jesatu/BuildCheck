...
export const occupationalSkills: OccupationalSkill[] = [
  ...
  skill(4, 40, ['armourers', 'militia'], { id: 'mighty-blow', name: 'Mighty Blow', learn: os('immune-repel-strikedown'), use: cs('large-weapon'), includes: ['immune-repel-strikedown'], excludes: ['goblin-resilience'], summary: 'Strikedown with a large weapon; immune to Repel and Strikedown.', source: 'HB p.94' }),
  ...
  skill(5, 50, ['bards'], { id: 'beguile', name: 'Beguile', restricted: true, learn: all(os('cast-mass-charms'), os('detect-remove-beguile')), replaces: ['detect-remove-beguile'], summary: 'Detect/remove Beguile; immune to Charms; innate Beguile for 4 power.', source: 'HB p.86' }),
  ...
  skill(3, 30, ['bards'], { id: 'script-master', name: 'Script Master <X>', param: 'Script category', repeatableWithParam: true, learn: os('translate-named-script'), summary: 'All scripts in one category. Replaces the TNS skills in that family.', source: 'HB p.96' }),
  ...
  skill(5, 50, ['casino'], { id: 'perform-teleport-rite', name: 'Perform Teleport Rite', restricted: true, learn: os('perform-transport-rite'), use: anyMagicCs, includes: ['perform-transport-rite'], summary: 'Adds Transportation and Teleport; Spell Reduction (1) on Teleport.', source: 'HB p.94' }),
  ...
  skill(5, 50, ['corruptors', 'incantors'], { id: 'dismiss-control-8', name: 'Dismiss/Control +8', restricted: true, learn: os('dismiss-control-6'), replaces: ['dismiss-control-6'], summary: '+8 to Dismiss and Control totals.', source: 'HB p.89' }),
  ...
  skill(5, 50, ['militia'], { id: 'magic-resistance', name: 'Magic Resistance', restricted: true, learn: os('immune-through'), replaces: ['immune-through'], includes: ['immune-through'], summary: 'Immune to Through; Damage Reduction (Harm and Mage Bolt).', source: 'HB p.93' }),
  ...
  skill(5, 50, ['bank', 'arcane'], { id: 'diagnose-powers', name: 'Diagnose Powers', restricted: true, learn: os('identify'), use: any(anyMagicCs, cs('sense-magic')), summary: 'Identify powers; restore 1 item card per day. (E11: printed use also needs a loresheet.)', source: 'HB p.89' }),
  ...
  skill(3, 30, ['bank'], { id: 'bank-advisor-associate', name: 'Bank Advisor (Associate)', restricted: true, learn: all(os('bank-advisor-clerk'), os('oathsworn', 'Bank')), use: os('oathsworn', 'Bank'), summary: '2 items per event.', source: 'HB p.86' }),
  ...
  skill(5, 50, ['martial'], { id: 'armour-mastery-expert', name: 'Armour Mastery (Expert)', restricted: true, learn: os('armour-mastery-advanced'), use: anyArmourCs, includes: ['armour-mastery-advanced'], summary: '+2 AV; immune to non-Artefact Crush.', source: 'HB p.85' }),
  ...
  special({ id: 'dismiss-rank-10', name: 'Dismiss Rank +10', use: ls, summary: '+10 own dismiss rank.', source: 'HB p.84' }),
  ...
  special({ id: 'beguile-level', name: 'Beguile <X>', param: 'Level', use: ls, summary: 'Innate Beguile X times per day. Each level replaces the previous.', source: 'HB p.86' }),
  ...
  special({ id: 'cast-all-incantation', name: 'Cast All Incantation', use: all(ls, cs('incantation')), replaces: ['cast-additional-incantation'], summary: 'Cast the combined Incantation list.', source: 'HB p.87' }),
  special({ id: 'cast-all-magecraft', name: 'Cast All Magecraft', use: all(ls, cs('spellcasting')), replaces: ['cast-additional-magecraft'], summary: 'Cast the combined Spellcasting list.', source: 'HB p.87' }),
  ...
  special({ id: 'damage-reduction-all', name: 'Damage Reduction (All)', use: ls, replaces: ['damage-reduction-crush'], summary: 'Damage Reduction vs all damage effects.', source: 'HB p.88' }),
  ...
  special({ id: 'immune-disease-decay', name: 'Immune to Disease and Decay', use: ls, summary: 'Immune to Disease and Decay.', source: 'HB p.92' }),
  ...
  special({ id: 'fearsome-aspect-level', name: 'Fearsome Aspect <X>', param: 'Level', use: ls, summary: 'Innate Mass Fear X times per day. Each level replaces the previous.', source: 'HB p.90' }),
  ...
  special({ id: 'retractable-claws', name: 'Retractable Claws', use: { flag: 'clawCompetency' }, summary: 'Natural claws that can be retracted.', source: 'HB p.95' }),
  ...
  special({ id: 'spell-reduction-2', name: 'Spell Reduction (2)', use: ls, summary: 'Spell Reduction (2) on all spells (not Iron Will).', source: 'HB p.96' }),
