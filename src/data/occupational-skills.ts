...
export const occupationalSkills: OccupationalSkill[] = [
  ...
  skill(5, 50, ['bards'], { id: 'beguile', name: 'Beguile', restricted: true, learn: all(os('cast-mass-charms'), os('detect-remove-beguile')), replaces: ['detect-remove-beguile', 'cast-mass-charms'], covers: ['immune-charms'], summary: 'Detect/remove Beguile; immune to Charms; innate Beguile for 4 power.', source: 'HB p.86' }),
