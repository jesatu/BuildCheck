...
| L14 | **No tier printed** for some awakened loresheet rows: Elf (TNS Elven, Immune to Sleep), Olog (Regeneration), Uruk (TNS Uruk, +1 LHV, Master Brewer, Herb Lore, Herb Lore (Improved)). | LS (PDF) | Use the handbook tier where there is one (so Uruk +1 LHV counts as Tier 5). Assume Tier 3 for Master Brewer (30 OSP) and Tier 4 for Olog Regeneration (40 OSP). **Confirm.** |
